...
import { CloudUpload, FileSpreadsheet, X, Download, CheckCircle } from 'lucide-react';
...
export default function UploadPageTemplate({ title, description, templateName, templateUrl }: Props) {
                    ...
                    <div className="bg-indigo-50/50 p-6 flex flex-col md:flex-row justify-between items-center border-b border-indigo-100 gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">Gunakan template <b>{templateName}</b> ini.</p>
                            </div>
                        </div>
                        <button 
                ...
                <div className="p-8 md:p-12">
                    ...
                    {!file ? (
                        ...
                        >
                            ...
                            <p className="text-sm text-gray-400">Atau klik untuk memilih file dari komputer</p>
                        </div>
                    ) : (
                        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 relative animate-in zoom-in-95 duration-300 shadow-sm">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h4 className="font-bold text-gray-800 truncate pr-8 text-lg">{file.name}</h4>
                                    {isUploading ? (
                                        <div className="mt-3">
